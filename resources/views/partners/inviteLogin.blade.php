        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    @endif
                    <h5 class="text-center text-white panel-text">Remplissez le formulaire d'inscription !</h5>
                    <div class="login-panel">
                        ...
                        <form action="{{-- route('admin.user.login') --}}" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="registerLastName" id="defaultRegisterFormLastName" class="form-control" placeholder="Saisir votre nom...">
                                <small class="error-log" id="errorLastName"></small>
                            </div>
                            <div class="form-group">
                                <input type="text" name="registerFirstName" id="defaultRegisterFormFirstName" class="form-control" placeholder="Saisir votre prenom...">
