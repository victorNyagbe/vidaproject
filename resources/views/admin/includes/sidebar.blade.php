...
<aside class="main-sidebar sidebar-light sidebar-bg elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ session()->get('profile') }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info info-user">
                <a href="#!" data-toggle="modal" data-target="#profilModal"
                    class="d-block">{{ session()->get('fullname') }}</a>
            </div>
        </div>
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}"
                        class="nav-link {{ $page == 'admin.dashboard' ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.message.chat') }}" class="nav-link {{ $page == 'admin.message' ? 'active' : '' }}">
              ...
              <p>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.clientSpace.index') }}"
                        class="nav-link {{ $page == 'admin.clientSpace' ? 'active' : '' }}">
