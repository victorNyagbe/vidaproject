            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 pb-5">
                        ...
                        <a href="#!" data-toggle="modal" data-target="#addClient" class="add-link"><i
                                class="bi bi-plus-circle-dotted"></i> Ajouter un client</a>
                    </div>
                </div>
                <!-- /.col -->
                <div class="row">
                    <div class="col-12">
                        <div class="card bg-secondary">
                            <div class="card-header cardHeader">
                                <h3 class="card-title count-header-title">Client du projet <span
                                        ...
                                        @if ($client != null)
                                            ...
                                            <div class="card card-widget widget-user shadow">
                                                ...
                                                <div class="widget-user-image">
                                                    {{-- @dd($client->profile) --}}
                                                    <img class="img-circle elevation-2" src="{{ $client->user->profile }}"
                                                        alt="User Avatar">
                                                </div>
                                                @php
                                                    $parts = explode(' ', $client->user->fullname);
                                                    $firstName = $parts[0];
                                                    $lastName = $parts[1];
                                                @endphp
                                                <div class="card-footer bg-light p-5">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <a href="mailto:{{ $client->user_mail }}"
                                                            class="info-client-link">{{ $client->user_mail }}</a>
                                                    </div>
                                                    <!-- /.row -->
                                                </div>
                                            </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content bg-secondary">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.projectBoard.sendInvitationForClient', $project) }}"
                                    method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="email" name="email" id="email" class="form-control"
                                            placeholder="Saisir le l'adresse email du client">
                                    </div>
                                    <div class="form-group">
