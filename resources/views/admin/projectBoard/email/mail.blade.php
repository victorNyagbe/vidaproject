...
<script>
  $(function () {
    ...
    $.ajax({
      type : "GET",
      url : "{{ route('admin.projectBoard.email.inboxMail', $project) }}",
    ...
    $('.toSend').click(function(e){
      ...
      $.ajax({
        type : "GET",
        url : "{{ route('admin.projectBoard.email.newMail', $project) }}",
        success : function(status){
    ...
    $('.sent').click(function(e){
      ...
      $.ajax({
        type : "GET",
        url : "{{ route('admin.projectBoard.email.sentMail', $project) }}",
        success : function(status){
    ...
    $('.draft').click(function(e){
      ...
      $.ajax({
        type : "GET",
        url : "{{ route('admin.projectBoard.email.draftMail', $project) }}",
        success : function(status){
    ...
    $('.trash').click(function(e){
      ...
      $.ajax({
        type : "GET",
        url : "{{ route('admin.projectBoard.email.trashMail', $project) }}",
        success : function(status){
