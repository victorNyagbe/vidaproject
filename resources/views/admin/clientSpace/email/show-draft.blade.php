            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 pb-5">
                        <a href="{{ route('admin.clientSpace.email.mail', $project) }}" class="btn btn-success btn-Clicked">
                        ...
                        <section class="content pb-3">
                            <div class="container-fluid">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form
                                            action="{{ route('admin.clientSpace.email.updateDraft', ['project' => $project, 'mail' => $mail]) }}"
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" name="to" disabled
                                                    value="{{ $project->user->email }}" placeholder="À">
                                            </div>
                                            <div class="form-group">
...
@section('script')
    <script>
        ...
        const newClientFileInput = document.getElementById('fileSelector');
        const newClientFileListDiv = document.getElementById('fileList');
        const newClientFilesToBeUploaded = document.getElementById('filesToBeUploaded');
        let objectURLs = []; // Stocker les URLs des objets créés

        const selectedFiles = [];

        newClientFileInput.addEventListener('change', function(event) {

            newClientFileListDiv.innerHTML = '';
            ...
            for (const file of files) {
                ...
                newClientFileListDiv.appendChild(fileNameContainer);
            ...
            newClientFilesToBeUploaded.value = JSON.stringify(objectExtract);
        ...
        function destroyFile(compteur, fileId) {
            ...
            let getnewClientFilesToBeUploaded = JSON.parse(newClientFilesToBeUploaded.value);
            console.log(getnewClientFilesToBeUploaded);
            // Supprimez le fichier du tableau
            getnewClientFilesToBeUploaded.splice(compteur, 1);
            ...
            newClientFileListDiv.removeChild(getFileNameContainer);

            // Mettez à jour la valeur de l'input caché "filesToBeUploaded"
            newClientFilesToBeUploaded.value = JSON.stringify(getnewClientFilesToBeUploaded);
        ...
        function saveAsDraft() {
            ...
            fetch('{{ route('admin.clientSpace.email.createDraftMail', $project) }}', {
                    method: 'POST',
                    headers: {
