            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 pb-5">
                        ...
                        <a href="#!" data-toggle="modal" data-target="#addProject" class="add-link"><i
                                class="bi bi-plus-circle-dotted"></i> Créer un projet</a>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('admin.project.project.store') }}" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="project_type">Type de projet (vous pouvez en choisir
                                                plusieurs)</label>
                                            <select name="project_type[]" id="project_type" class="select2 form-control"
                                                multiple="multiple" data-placeholder="Choisir le type de projet"
                                                style="width: 100%;">
                                            ...
                                            <div class="custom-control custom-checkbox first-checkbox">
                                                <div class="checkbox-block1">
                                                    <input class="custom-control-input" type="checkbox" id="customCheckbox1"
                                                        value="option1">
                                                    <label for="customCheckbox1" class="custom-control-label">Date de
                                                        début</label>
                                                </div>
                                            </div>
                                            <div class="custom-control custom-checkbox second-checkbox">
                                                <div class="checkbox-block2">
                                                    <input class="custom-control-input" type="checkbox" id="customCheckbox2"
                                                        value="option2">
                                                    <label for="customCheckbox2" class="custom-control-label">Date de
                                                        finalisation</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group start-input">
                                            ...
                                            <input name="date_debut" id="date_debut" placeholder="Select date"
                                                type="date" class="form-control">
                                        </div>
                                        <div class="form-group end-input">
                                            <label for="date_fin">Date de fin du projet</label>
                                            <input name="date_fin" id="date_fin" placeholder="Select date"
                                                type="date" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-primary text-uppercase">Ajouter le
                                                    projet</button>
                                            </div>
                                        </div>
                                    </form>
