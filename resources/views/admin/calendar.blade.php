...
@section('style')
    <!-- fullCalendar -->
  <link rel="stylesheet" href="{{ asset('styles/admin/plugins/fullcalendar/main.css') }}">

  <link rel="stylesheet" href="{{ asset('styles/admin/calendar.css') }}">
@endsection
...
@section('script')
    <script src="{{ asset('styles/admin/plugins/fullcalendar/main.js') }}"></script>
    <script>
        $(function () {
