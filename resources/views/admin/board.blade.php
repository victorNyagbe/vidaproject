                ...
                <div class="row">
                    <div class="col-12 pb-5">
                        ...
                        @if (session()->get('accessLevel') == 'Owner')
                            <a href="#!" data-toggle="modal" data-target="#addTask" class="add-link"><i
                                    class="bi bi-plus-circle-dotted"></i> Ajouter une tâche</a>
                        @endif
                    </div>
                </div>
                <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    @forelse ($tasks as $task)
                                                        <tr>
                                                            <td>{{ $compteur }}</td>
                                                            <td>{{ $task->title }}</td>
                                                            <td>{{ \App\Models\User::where('id', $task->project_user_id)->value('fullname') }}
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="desc">
                                                                {{ \Illuminate\Support\Str::substr($task->description, 0, 55) . '....' }}
                                                            </td>
                                                            <td>
                                                                @if (session()->get('accessLevel') == 'Owner')
                                                                    <div class="btn-group" role="group"
                                                                        ...
                                                                        <a href="{{ route('admin.task.destroy', $task) }}"
                                                                            class="btn btn-sm btn-danger"
                                                                            onclick="return confirm('Voulez-vous vraiment supprimer cette tâche ?')"><i
                                                        ...
                                                        <div id="showTask{{ $task->id }}" class="modal fade"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body task-show">
                                                                        ...
                                                                        <h4><b>Collaborateur en charge : </b>
                                                                            {{ \App\Models\User::where('id', $task->project_user_id)->value('fullname') }}
                                                                        </h4>
                                                                        <h4><b>Statut : </b>
                                                                            @if ($task->status == 0)
                                                                                A FAIRE
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form
                                                                            action="{{ route('admin.task.update', [$project, $task]) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('PATCH')
                                                                            <div class="form-group">
                                                                                <label for="task_title">Titre de tâche:
                                                                                </label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="task_date_end">Date de fin de
                                                                                    la tâche: </label>
                                                                                <input type="date" name="task_date_end"
                                                                                    value="{{ $task->deadline }}"
                                                                                    id="task_date_end"
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea name="task_description" id="task_description" class="form-control" rows="5"
                                                                                    placeholder="Saisir une description à la tâche...">
                                                                            {{ $task->description }}
                                                                                </textarea>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="project_user">Lier un
                                                                                    collaborateur à la tâche</label>
                                                                                <select name="project_user"
                                                                                    ...
                                                                                    @foreach ($users as $user)
                                                                                        <option
                                                                                            value="{{ $user->id }}"
                                                                                            {{ $user->id == $task->project_user_id ? 'selected' : '' }}>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="d-flex justify-content-end">
                                                                                    <button type="submit"
                                                                                        class="btn btn-sm btn-success text-uppercase">Modifier
                                                                                        la tâche</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="7">
                                                                <h6 class="text-center text-secondary">Aucune tâche
                                                                    disponible</h6>
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('admin.task.store', $project) }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="task_description" id="task_description" class="form-control" rows="5"
                                                            placeholder="Saisir une description à la tâche..."></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="project_user">Lier un collaborateur à la tâche</label>
                                                        <select name="project_user" id="project_user"
                                                            class="form-control">
                                                            @foreach ($users as $user)
                                                    ...
                                                    <div class="form-group">
                                                        <div class="d-flex justify-content-end">
                                                            <button type="submit"
                                                                class="btn btn-sm btn-success text-uppercase">Ajouter la
                                                                tâche</button>
                                                        </div>
                                                    </div>
                                                </form>
...
@section('script')
    ...
    <script>
        ...
        //         const editorCode = $('.task_description').summernote('code').replace(/<\/?[^>]+(>|$)/g,
        //         " ");
